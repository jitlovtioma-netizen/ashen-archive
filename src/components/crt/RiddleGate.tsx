...
const RIDDLES: Record<string, {
  ...
  "Надежда": {
    ...
    riddle: [
      "Когда тьма поглотила всех,",
      "И демон заключил друзей в сон,",
      "Лишь я пришла к нему во сне,",
      "Лишь он один меня помнит.",
      "Я не богиня и не дух,",
      "Я — то, что остаётся, когда гаснет свет.",
      "Назови моё имя — и я явлюсь тебе.",
    ],
    valid: ["надежда", "надежда.", "надежда,"],
    hint: "// назови имя той, что спасает во тьме //",
  },
};
