...
const RIDDLES: Record<string, {
  ...
  "Морфея": {
    sigil: "😴",
    title: "МОРФЕЯ",
    subtitle: "// сущность · сон · искажена //",
    riddle: [
      "Без него и царь, и раб,",
      "Всего б за пару дней ослаб!",
      "Чем одарила нас природа",
      "Как радость на долгие годы?",
    ],
    valid: ["сон", "сон.", "сон,"],
    hint: "// разгадай загадку, чтобы открыть досье Морфеи //",
  },
};
